...
type ServerInterface interface {
	...
	GetSharedInventory(w http.ResponseWriter, r *http.Request, token string)
	...
	// (DELETE /api/v1/sources/{id}/share)
	DeleteShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID)

	// (POST /api/v1/sources/{id}/share)
	CreateOrGetShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID)
...
// (GET /api/v1/shared/{token})
func (_ Unimplemented) GetSharedInventory(w http.ResponseWriter, r *http.Request, token string) {
...
// (DELETE /api/v1/sources/{id}/share)
func (_ Unimplemented) DeleteShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}

// (POST /api/v1/sources/{id}/share)
func (_ Unimplemented) CreateOrGetShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetSharedInventory operation middleware
func (siw *ServerInterfaceWrapper) GetSharedInventory(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSharedInventory(w, r, token)
	}))
...
// CreateOrGetShareLink operation middleware
func (siw *ServerInterfaceWrapper) CreateOrGetShareLink(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateOrGetShareLink(w, r, id)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/v1/shared/{token}", wrapper.GetSharedInventory)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/api/v1/sources/{id}/share", wrapper.DeleteShareLink)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/v1/sources/{id}/share", wrapper.CreateOrGetShareLink)
	})
	r.Group(func(r chi.Router) {
...
type GetSharedInventoryRequestObject struct {
	Token string `json:"token"`
}

type GetSharedInventoryResponseObject interface {
	VisitGetSharedInventoryResponse(w http.ResponseWriter) error
}

type GetSharedInventory200JSONResponse SharedInventory

func (response GetSharedInventory200JSONResponse) VisitGetSharedInventoryResponse(w http.ResponseWriter) error {
...
type GetSharedInventory400JSONResponse Error

func (response GetSharedInventory400JSONResponse) VisitGetSharedInventoryResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type GetSharedInventory404JSONResponse Error

func (response GetSharedInventory404JSONResponse) VisitGetSharedInventoryResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type GetSharedInventory500JSONResponse Error

func (response GetSharedInventory500JSONResponse) VisitGetSharedInventoryResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type DeleteShareLinkRequestObject struct {
	Id openapi_types.UUID `json:"id"`
}

type DeleteShareLinkResponseObject interface {
	VisitDeleteShareLinkResponse(w http.ResponseWriter) error
}

type DeleteShareLink200JSONResponse Status

func (response DeleteShareLink200JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type DeleteShareLink400JSONResponse Error

func (response DeleteShareLink400JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type DeleteShareLink401JSONResponse Error

func (response DeleteShareLink401JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(401)
...
type DeleteShareLink403JSONResponse Error

func (response DeleteShareLink403JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(403)
...
type DeleteShareLink404JSONResponse Error

func (response DeleteShareLink404JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type DeleteShareLink500JSONResponse Error

func (response DeleteShareLink500JSONResponse) VisitDeleteShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type CreateOrGetShareLinkRequestObject struct {
	Id openapi_types.UUID `json:"id"`
}

type CreateOrGetShareLinkResponseObject interface {
	VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error
}

type CreateOrGetShareLink200JSONResponse ShareLink

func (response CreateOrGetShareLink200JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type CreateOrGetShareLink400JSONResponse Error

func (response CreateOrGetShareLink400JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type CreateOrGetShareLink401JSONResponse Error

func (response CreateOrGetShareLink401JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(401)
...
type CreateOrGetShareLink403JSONResponse Error

func (response CreateOrGetShareLink403JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(403)
...
type CreateOrGetShareLink404JSONResponse Error

func (response CreateOrGetShareLink404JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type CreateOrGetShareLink500JSONResponse Error

func (response CreateOrGetShareLink500JSONResponse) VisitCreateOrGetShareLinkResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// (GET /api/v1/shared/{token})
	GetSharedInventory(ctx context.Context, request GetSharedInventoryRequestObject) (GetSharedInventoryResponseObject, error)
	...
	// (DELETE /api/v1/sources/{id}/share)
	DeleteShareLink(ctx context.Context, request DeleteShareLinkRequestObject) (DeleteShareLinkResponseObject, error)

	// (POST /api/v1/sources/{id}/share)
	CreateOrGetShareLink(ctx context.Context, request CreateOrGetShareLinkRequestObject) (CreateOrGetShareLinkResponseObject, error)
...
// GetSharedInventory operation middleware
func (sh *strictHandler) GetSharedInventory(w http.ResponseWriter, r *http.Request, token string) {
	var request GetSharedInventoryRequestObject

	request.Token = token

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetSharedInventory(ctx, request.(GetSharedInventoryRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetSharedInventory")
	}
	...
	} else if validResponse, ok := response.(GetSharedInventoryResponseObject); ok {
		if err := validResponse.VisitGetSharedInventoryResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
...
// DeleteShareLink operation middleware
func (sh *strictHandler) DeleteShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID) {
	var request DeleteShareLinkRequestObject

	request.Id = id

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.DeleteShareLink(ctx, request.(DeleteShareLinkRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "DeleteShareLink")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(DeleteShareLinkResponseObject); ok {
		if err := validResponse.VisitDeleteShareLinkResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// CreateOrGetShareLink operation middleware
func (sh *strictHandler) CreateOrGetShareLink(w http.ResponseWriter, r *http.Request, id openapi_types.UUID) {
	var request CreateOrGetShareLinkRequestObject

	request.Id = id

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.CreateOrGetShareLink(ctx, request.(CreateOrGetShareLinkRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "CreateOrGetShareLink")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(CreateOrGetShareLinkResponseObject); ok {
		if err := validResponse.VisitCreateOrGetShareLinkResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
